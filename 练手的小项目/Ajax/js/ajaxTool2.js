...
function GET1(url,obj,success,error,timerOut) {
    //001 创建请求对象
    var xhr;
...
function POST1(url,obj,success,error,timerOut){
    //01 创建请求对象
    var xhr;
    if(window.XMLHttpRequest)
    {
...
{
    return Ajax("get",url,obj,success,error,timerOut);
}
function POST(url,obj,success,error,timerOut)
{
    return Ajax("post",url,obj,success,error,timerOut);
}

function Ajax(type,url,obj,success,error,timerOut) {
